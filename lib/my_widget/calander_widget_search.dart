...
import '../src/elements/TimePickerDialog_search.dart';
...
class CalendarDialogsearch extends StatefulWidget {
  String restaurantId;
  bool isDelivery;
  int selectedIndex;
  bool issearch;
  ...
  int subtotal;
  CalendarDialogsearch(this.restaurantId, this.isDelivery,this.selectedIndex,this.issearch,this.restaurant,this.selectedFoodList,this.fooditems,this.subtotal);


  @override
  _CalendarDialogsearchState createState() => _CalendarDialogsearchState();
}

class _CalendarDialogsearchState extends State<CalendarDialogsearch> {
             ...
             //     print(date);  // Output: 2023-06-21
               //   print("DS>> selected date:  "+_selectedDate.toString());
                  if(_selectedDate.toString().isNotEmpty){
                    ...
                    showTimePickerDialog_search(context, widget.restaurantId, widget.isDelivery, _selectedDate.toString(),widget.selectedIndex,widget.issearch ,
                        widget.fooditems,
                        widget.subtotal,
...
// Usage
void showCalendarDialogsearch(BuildContext context, String restaurantId, bool isDelivery, List<Map<String,dynamic>> fooditems ,int selectedIndex,int subtotal, List<Food> selectedFoodList, Restaurant restaurant,{bool issearch = false}) {
 print("DS>> ##"+isDelivery.toString());
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return CalendarDialogsearch(restaurantId, isDelivery,selectedIndex,issearch,restaurant,selectedFoodList,fooditems,subtotal);
    },
  );
}
