...
import 'package:food_delivery_app/my_widget/timepicker_widget_withoutRestId.dart';
...
class CalendarDialogWithoutRestaurant extends StatefulWidget {
 // String restaurantId;
 // bool isDelivery;
  CalendarDialogWithoutRestaurant();
...
class _CalendarDialogState extends State<CalendarDialogWithoutRestaurant> {
          ...
          SizedBox(
            ...
            child: TableCalendar(
              ...
              onDaySelected: (date, _) {
                setState(() {
                  _selectedDate = date;
                  _focusedDay = date; // Add this line to keep the calendar focused on the selected month
                });
              },
          ...
          Padding(
            ...
            child: Container(
              ...
              child: ElevatedButton(
               ...
               //   print("DS>> *** selected date:  "+date);  // Output: 2023-06-21
            //      print("DS>> selected date:  "+_selectedDate.toString());
                  if(_selectedDate.toString().isNotEmpty){
                    if(mounted){
                      Navigator.of(context, rootNavigator: true).pop();
                    }
                    //showTimePickerDialogWithoutRestId(context, date);
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                              TimePickerDialogWithoutRestaurant(date)
                      ),
                    );
                  }
...
// Usage
void showCalendarDialoggWithoutRestaurant(BuildContext context) {
// print("DS>> ##"+isDelivery.toString());
  showDialog(
    context: context,
    barrierDismissible: false,
    builder: (BuildContext context) {
      return CalendarDialogWithoutRestaurant();
    },
  );
}
