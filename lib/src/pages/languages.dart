              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  onTap: () async {
                    ...
                    settingRepo.setDefaultLanguage(_language.code,_language.englishName);

                    //Navigator.of(context).pushReplacementNamed('/Pages', arguments: 2);
                   /* Navigator.push(
                      context,
                        MaterialPageRoute(builder: (_) => PagesWidget(currentTab: 2))
                    );*/
                   /* Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => HomeWidget(
                      parentScaffoldKey: widget.key,
                      currentTab: 2,
                        ...
                        Stack(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.all(Radius.circular(40)),
                                color: mainColor(_language.selected ? 0.85 : 0),
                              ),
                              child: Icon(
                                Icons.check,
