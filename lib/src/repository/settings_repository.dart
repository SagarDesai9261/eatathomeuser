...
Future<void> setDefaultLanguage(String language, String englishName) async {
  if (language != null) {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('language', language);
    await prefs.setString('languagename', englishName);
  }
}
...
Future<String> getDefaultLanguageName() async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
